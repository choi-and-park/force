...
import { ShelfArtworkFragmentContainer } from "v2/Components/Artwork/ShelfArtwork_Nuart"
import { HomeArtworkModuleContextFragmentContainer } from "./HomeArtworkModuleContext"
import { useLazyLoadComponent } from "v2/Utils/Hooks/useLazyLoadComponent"

const HomeArtworkModuleRailQueryRenderer = ({ artworkModule }) => {
  if (artworkModule.items.length === 0) {
    return null
  }
  return (
    <HomeArtworkModule
    ...
    >
      <Shelf>
        {artworkModule.items.map(artwork => {
          return (
...
export const HomeArtworkModuleRailLazyQueryRenderer = ({ artworkModule }) => {
  ...
  return (
    <>
      ...
      {isEnteredView ? (
        <HomeArtworkModuleRailQueryRenderer artworkModule={artworkModule} />
      ) : (
        <HomeArtworkModulePlaceholder title={artworkModule.title} />
      )}
    </>
  )
}
